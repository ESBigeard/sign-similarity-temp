...
if __name__ == "__main__":
    ...
    for K in Ks:
        ...
        for column_og in df.columns:
            ...
            column = str(column_og).replace("_", "")
            ...
            for label, pairs in video_pairs.items():
                ...
                if column in pairs:
                    print(f"Found column {column} in pairs: {pairs}")
            ...
            for video in videos[:K]:
                ...
                print(f"Checking video: {video} in column {column_og}")
    ...
    with open(f'simcheck/dimreduc/results/evaluations/{exp}_evaluation_results.json', 'w') as f:
